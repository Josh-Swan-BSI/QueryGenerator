...
REPO = "https://github.com/QueryGenerator/QueryGenerator/raw/main/QueryGenerator.zip"
...
class QueryGenerator:
    ...
    def __init__(self, root):
        ...
        self.root.title(f"R&I Query Generator v{VERSION} {RELEASE}")
...
try:
    ...
    with open(r"C:\Users\swanj\OneDrive - British Standards Institution\Desktop/QUERYGENTEST.txt", "r") as f:
        external_version = f.read()
...
if checkVersion > convertVersion(VERSION):
    #Todo add in autoupdating of app here. It should install to a default directory for all users. Users will need to reapply shortcuts as a one-off
    # Check Auto Update App Chat GPT message. During testing, you may need to use a temp file for signalling an update as the github page will make everyone update!
    ...
    try:
        ...
        def update_and_restart(current_exe_path):
        ...
        user_profile = os.getenv('LOCALAPPDATA')
        exe_path = os.path.join(user_profile, "Query_Generator/QueryGenerator/QueryGenerator.exe")
        print(exe_path)
        update_and_restart(current_exe_path=exe_path)

...
class QueryGenerator:
    ...
    def setup_ui(self): # this sets up your app layout
        ...
        self.logo = PhotoImage(file="logosmall.png") # if you don't use self garbage collection will remove it from memory and it won't display
        ...
        label1.grid(row=0, column=0, sticky="NSEW", padx=5, pady=10)
        Hovertip(label1, "The table you would like to query.\nUsually this is the latest table available.")

        # SQL Table TextBox
        self.textbox1 = Text(gridFrame2, padx=5, pady=10, font=('Raleway', 12), width=15, height=1, bg=boxColour)
